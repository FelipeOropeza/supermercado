...
<body class="text-gray-800 bg-[#F9FAFB] min-h-screen antialiased flex flex-col md:flex-row" x-data="{ mobileMenuOpen: false }">
    ...
    <?php if (!($hideSidebar ?? false)): ?>
        ...
        <aside :class="mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'"
               class="-translate-x-full md:translate-x-0 fixed md:sticky top-0 left-0 z-[50] w-72 h-screen bg-white border-r border-gray-100 flex flex-col transition-transform duration-300 ease-in-out shadow-2xl md:shadow-none shrink-0">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
                ...
                $links = [
                    ...
                    ['url' => '/admin/pedidos', 'label' => 'Pedidos', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01m-.01 4h.01" />', 'active' => strpos($currentUri, '/admin/pedidos') !== false],
    ...
    <!-- CONTENT AREA -->
    <main class="flex-1 w-full min-h-screen relative <?= ($hideSidebar ?? false) ? 'p-0' : 'p-4 sm:p-6 md:p-10' ?> bg-gray-50 overflow-hidden">
