...
- [ ] Implementar as telas e lógicas de Login e Cadastro de Usuário (`AuthController`).
- [ ] Criar/Ajustar um **Middleware** capaz de verificar se o usuário logado possui a *role* `admin` ou `cliente` para bloquear acessos não autorizados.
